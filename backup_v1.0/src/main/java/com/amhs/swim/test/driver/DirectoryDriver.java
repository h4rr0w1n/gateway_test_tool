...
/**
 * Driver tương tác với ATN Directory Service (DSAPI & ATNDS).
 * Tuân thủ EUR Doc 047 v3.0, Chương 3.6 (Directory Services).
 * Sử dụng API mô phỏng dựa trên Isode DSAPI và ATNDS API.
 * Tham khảo: Directory-Client-API.pdf, ATN-Directory-API.pdf.
 */
